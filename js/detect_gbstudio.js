...
// UI_b.c uicolors
    ...
    const sig_gbs_musicmanager_c_FX_ADDR_LO__2_0_0_b5_to_3_0_3 = new Uint8Array([0x05, 0x04, 0x05, 0x04, 0x00, 0x10, 0x16, 0x1A, 0x20, 0x00, 0x0E, 0x0D, 0x0B, 0x07]);
    ...
    const sig_gbs_fade_manager_c_dmgfadetowhitestep_2_0_0_b5_plus = new Uint8Array([0x3A, 0x5E, 0xB7, 0xC8, 0x57, 0x26, 0x04, 0x7B, 0xE6, 0x03, 0x28, 0x01, 0x3D, 0xCB, 0x3F, 0xCB, 0x1D, 0xCB, 0x3F, 0xCB, 0x1D, 0xCB, 0x3B, 0xCB, 0x3B, 0x25, 0x20, 0xEB, 0x5D, 0x15, 0x20, 0xE5, 0xC9]);
...
function checkGBStudio(u8RomBuffer) {
    ...
    if (findPattern_u8(u8RomBuffer, sig_gbs_math_c_sinetable_3_0_0_alpha1_plus) &&
        findPattern_u8(u8RomBuffer, sig_gbs_fade_manager_c_dmgfadetowhitestep_2_0_0_b5_plus)) {
        // entry_check_match() Relies on GBDK tool check being run before ZGB is tested (it is)

        // ADDED:Apr 30, 2021 (v2.0.0-beta5) -> REMOVED:Feb 20, 2022 (3.0.3)
        if (findPattern_u8(u8RomBuffer, sig_gbs_musicmanager_c_FX_ADDR_LO__2_0_0_b5_to_3_0_3)) {
