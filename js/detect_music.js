...
function check_music(u8RomBuffer) {
    ...
    // Scope so the var defs below don't leak out and the global constants created by them can be used instead
    {
        ...
        let sig_str_MusyX_1 = "sig_str_MusyX_1";
        let sig_str_MusyX_2 = "sig_str_MusyX_2";
        let sig_str_MusyX_3 = "sig_str_MusyX_3";
        let sig_str_freaq_1 = "sig_str_freaq_1";
        let sig_str_freaq_2 = "sig_str_freaq_2";
        let sig_str_lsdj_1 = "sig_str_lsdj_1";
        let sig_str_lsdj_2 = "sig_str_lsdj_2";
        let sig_gbsoundsystem_modern_SSFP_multi_sfx = "sig_gbsoundsystem_modern_SSFP_multi_sfx";
        let sig_gbsoundsystem_MultiSFXLoop = "sig_gbsoundsystem_MultiSFXLoop";
        ...
        let sig_hugetracker_fx_vol_slide_base_v1 = "sig_hugetracker_fx_vol_slide_base_v1";
        let sig_hugetracker_fx_vol_slide_base_v2 = "sig_hugetracker_fx_vol_slide_base_v2";
        let sig_hugetracker_fortissimo_fx_vol_slide = "sig_hugetracker_fortissimo_fx_vol_slide";
        let sig_hugetracker_fx_get_note_poly = "sig_hugetracker_fx_get_note_poly";
        let sig_hugetracker_fx_coffeebat_get_shift_ch3 = "sig_hugetracker_fx_coffeebat_get_shift_ch3";
        let sig_tbengine_noisetable = "sig_tbengine_noisetable";
        let sig_blackboxplayer_1 = "sig_blackboxplayer_1";
        ...
        let sig_mplay1 = "sig_mplay1";
        let sig_mmlgb1 = "sig_mmlgb1";
