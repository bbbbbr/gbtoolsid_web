...
function check_music(u8RomBuffer) {
    ...
    // (for example, musboxex.gb embed starts at 0x0175, but first bytes are jumps not present in other uses, instead try 0x180, below is from further past)
    const sig_blackboxplayer = new Uint8Array([0x09,  0x06,  0x25,  0x06,  0x40,  0x06,  0x59,  0x06,  0x70,  0x06,  0x87,  0x06,  0x9C,  0x06,  0xB0,  0x06,  0xC3,  0x06,  0xD5,  0x06,  0xE5,  0x06,  0xF5,  0x06,  0x04,  0x07]);
    ...
    if (findPattern_u8(u8RomBuffer, sig_blackboxplayer))
        entry_add(entry);
